...
mapshaper geo/2562.geojson \
  ...
  -filter-fields id,province_id,zone_id,zone_name,province_name,province_name_en,region_id,region_name,code_name,code_name_en,zone_detail_text \
